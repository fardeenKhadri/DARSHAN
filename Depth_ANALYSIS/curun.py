...
depth_anything.load_state_dict(torch.load(
    'Depth_Anything/checkpoints/depth_anything_v2_vits.pth',
    map_location=DEVICE
))
depth_anything.eval()
...
while True:
    ...
    cv2.putText(overlay, "Depth Estimation - Press 'Q' to Exit | 'F' to Toggle Fullscreen",
    ...
    color = (255, 255, 255) if direction != "STOP" else (0, 0, 255)  # Red for STOP
